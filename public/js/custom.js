...
function Pop(){var cssRuleFile="https://popupsmart.com/freechat_style.css";let lnk=document.createElement("link");lnk.setAttribute("rel","stylesheet");lnk.setAttribute("type","text/css");lnk.setAttribute("href",cssRuleFile);document.getElementsByTagName("head")[0].appendChild(lnk);var conDivObj;
    let content={
        show:false,
