    ...
    <Link href='/' passHref legacyBehavior>
      <div className='flex flex-nowrap items-center cursor-pointer font-extrabold'>
        ...
        <div id='logo-text' className='group rounded-2xl flex-none relative'>
          ...
          <div className='flex justify-center rounded-2xl group-hover:bg-[#4c3b30] w-full group-hover:opacity-100 opacity-0 invisible group-hover:visible absolute top-0 py-1 duration-200'>
