...
const BLOG = {
  ...
  CONTACT_FACEBOOK: process.env.NEXT_PUBLIC_CONTACT_FACEBOOK || 'https://www.facebook.com/groups/1792248637960826/', // FACEBOOK 連結
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-R8YN6BCTGN', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 'o5hiuy00dn', // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
